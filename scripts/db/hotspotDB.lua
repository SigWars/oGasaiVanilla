...
function hotspotDB:setup()
	...
	-- Undead
	hotspotDB:addHotspot("Tirisfal Glades - The Skittering Dark 13 - 15", "Undead", 13, 15, 1200.01, 1991.25, 9.26);
	hotspotDB:addHotspot("Silverpine - Ambermill 16 - 18", "Undead", 16, 18, -130.59, 1004.79, 68);
	hotspotDB:addHotspot("Tirisfal Glades - Pyrewood Village 26 - 28", "Undead", 10, 28, -377.15, 1517.74, 17.01);
